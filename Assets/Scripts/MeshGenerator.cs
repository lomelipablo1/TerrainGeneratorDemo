        ...
        for(int y = 0; y < height; y++){
            for(int x = 0; x < width; x++){
                ...
                if(x < width - 1 && y < height - 1){
                    meshData.AddTriangle(vertexIndex, vertexIndex + width + 1, vertexIndex + width); // left triangle (imagine square)
                    meshData.AddTriangle(vertexIndex + width + 1, vertexIndex, vertexIndex + 1); // right triagle
                }
